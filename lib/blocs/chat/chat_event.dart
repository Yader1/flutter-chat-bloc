...
class ChatEvent with _$ChatEvent {
  ...
  const factory ChatEvent.sendMessage(int chatId, ChatMessage message, {required String socketId}) = SendMessage;
  const factory ChatEvent.chatSelected(ChatEntity chat) = ChatSelected;
  const factory ChatEvent.addNewMessage(ChatMessageEntity message) = AddNewMessage;
}