...
import 'package:flutter_chat_bloc/models/chat_model.dart';
import 'package:flutter_chat_bloc/models/requests/create_chat_request.dart';
import 'package:flutter_chat_bloc/repositories/chat/base_chat_repository.dart';
...
class ChatRepository extends BaseChatRepository{
  ...
  Future<AppResponse<ChatEntity?>> createChat(CreateChatRequest request) async {
    final response = await _dioClient.post(Endpoints.createChat, data: request.toJson());
